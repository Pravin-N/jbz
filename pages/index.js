...
export default function Home({ features }) {
  const metaData = {
    ...
    description:
      "Setup your business in Dubai easily with the help of Just Business. Depending on you business needs, we guide you to choose the correct license & provide transparent pricing.",
    keywords:
